                        ...
                        <form action="/register" method="POST">
                           @csrf
                            ...
                            <div class="form-floating">
                                <input type="text" name="name" class="form-control mt-2" id="name" placeholder="name" autofocus>
                            ...
                            <div class="form-floating">
                                <input type="text" name="role" class="form-control mt-2" id="role" placeholder="role" autofocus>
